...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mainlog.setGeometry(QtCore.QRect(380, 180, 150, 150))
        self.mainlog.setText("")
        #
        self.mainlog.setPixmap(QtGui.QPixmap("./stylelogo.png"))
        self.mainlog.setScaledContents(True)
        self.mainlog.setObjectName("mainlog")
        self.About = QtWidgets.QLabel(self.centralwidget)
        self.About.setGeometry(QtCore.QRect(0, 0, 960, 601))
        self.About.setText("")
        #关于图像
        self.About.setPixmap(QtGui.QPixmap("./bg.png"))
        ...
        #小logo
        self.smalllogo.setPixmap(QtGui.QPixmap(""))
        ...
        self.when.setText("")
        #主页提示
        self.when.setPixmap(QtGui.QPixmap(""))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("artme", "图像风格迁移"))
        self.contentbutton.setText(_translate("MainWindow", "内容图片"))
        self.stylebutton.setText(_translate("MainWindow", "风格图片"))
        self.generatebutton.setText(_translate("MainWindow", "生成"))
        self.savebutton.setText(_translate("MainWindow", "保存图片"))
        self.comboBox.setItemText(0, _translate("MainWindow", "低"))
        self.comboBox.setItemText(1, _translate("MainWindow", "中"))
        self.comboBox.setItemText(2, _translate("MainWindow", "高"))
        self.qualty.setText(_translate("MainWindow", "质量: "))
        ...
        self.res.setText(_translate("MainWindow", "解析度:"))
        self.menuHome.setTitle(_translate("MainWindow", "主页"))
        self.menuCreate_New.setTitle(_translate("MainWindow", "开始创建"))
        self.menuAbout.setTitle(_translate("MainWindow", "关于"))

        #self.menuExit.setTitle(_translate("MainWindow", "帮助"))
        self.actionCreate_New.setText(_translate("MainWindow", "开始创建"))
        self.actionHome.setText(_translate("MainWindow", "主页"))
        self.actionAbout.setText(_translate("MainWindow", "关于"))

        #self.actionExit.setText(_translate("MainWindow", "帮助"))
        self.actionExit2.setText(_translate("MainWindow", "退出"))
